...
pub enum ParameterValueSequence {
    Track(TrackValueSequence),
    TrackSend(TrackSendValueSequence),
    TrackFx(TrackFxValueSequence),
    TrackFxParam(TrackFxParamValueSequence),
    // etc.
}

#[derive(Clone, Debug, PartialEq, Eq, Hash)]
pub struct TrackValueSequence {
    pub track_guid: String,
}

#[derive(Clone, Debug, PartialEq, Eq, Hash)]
pub struct TrackSendValueSequence {
    pub track_guid: String,
    pub send_guid: String,
}

#[derive(Clone, Debug, PartialEq, Eq, Hash)]
pub struct TrackFxValueSequence {
    pub track_guid: String,
    pub fx_guid: String,
}

#[derive(Clone, Debug, PartialEq, Eq, Hash)]
pub struct TrackFxParamValueSequence {
    pub track_guid: String,
    pub fx_guid: String,
...
impl ParameterSequence {
    ...
    fn parse(&self, osc_address: &str) -> Option<ParameterValueSequence> {
        match self {
            ...
            ParameterSequence::TrackGUID => {
                let re = Regex::new(r"^/track/([^/]+)").unwrap();
                re.captures(osc_address).map(|caps| {
                    ParameterValueSequence::Track(TrackValueSequence {
